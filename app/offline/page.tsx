    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-muted-foreground mb-6">
          It looks like you've lost your internet connection. Some content may
        ...
        <div className="space-y-3">
          ...
          <Link
            href="/"
            className="block w-full px-6 py-3 border border-border rounded-lg hover:bg-accent transition-colors"
          >
            Go to Home
          </Link>
        </div>
