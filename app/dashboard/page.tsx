...
export default function AdminDashboard() {
  ...
  const { hasPermission, userRole, canAccessDashboard } = useRoleAccess();
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Article Statistics - visible to all dashboard users */}
      ...
      {/* User Statistics - only for superadmin and admin */}
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          {hasPermission("view_analytics") && (
            <QuickActionButton href="/dashboard/analytics" label="Analytics" />
          )}
        </div>
      </div>
    </div>
